...
function VideoPages() {
  ...
  function ViewsCount(){
    ...
    .catch((error)=>{
      console.log('video views count', error)
    })
            ...
            <div className="col-md-8">
              <div className="single-video-left">
                ...
                <div className="single-video-title box mb-3">
                  <h2><a href="#">{currVedioData?.video_name}</a></h2>
                  <p className="mb-0"><i className="fas fa-eye" /> {currVedioData?.video_views
                        ? `${currVedioData?.video_views}M`
                        : "M"}{" "} views</p>
                </div>
                <div className="single-video-author box mb-3">
                  <div className="float-right"><button className="btn btn-danger" type="button">Subscribe <strong>1.4M</strong></button> <button className="btn btn btn-outline-danger" type="button"><i className="fas fa-bell" /></button></div>
                  <img
                  ...
                  <p><a href="#"> <strong>
                        ...
                        <span title data-placement="top" data-toggle="tooltip" data-original-title="Verified"><i className="fas fa-check-circle text-success" /></span></p>
                  <small>  Published on{" "}
              ...
              <div className="single-video-right">
                <div className="row">
                  ...
                  <div className="col-md-12"
                    ...
                    {upComingVideoData.map((data, index)=>data?.video[1]?.filename ?(
                    <div className="video-card video-card-list">
                      <div className="video-card-image"   onClick={() => handleVedioID(data._id)}>
                        
                        <a className="play-icon" href="#"><i className="fas fa-play-circle" /></a>
                        <a href="#"><img className="img-fluid" src={`http://103.104.74.215:3003/uploads/${data?.video[1]?.filename}`} 
                        alt
                         />
                         </a>
                      ...
                      <div className="video-card-body">
                        ...
                        {data?.video_views } M views &nbsp;<i className="fas fa-calendar-alt" /> {" "}{data?.current_date}
                        </div>
                      </div>
                    </div>
