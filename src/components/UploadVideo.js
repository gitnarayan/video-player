                    ...
                    <div className="col-lg-12">
                      <div className="form-group">
                        ...
                        <textarea
                          ...
                          required
                          value={videoDescrip}
                          onChange={(event) => setVideoDescrip(event.target.value)}
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="row">
                    <div className="col-lg-6">
                      <div className="form-group">
                        ...
                        <input type="text" placeholder="e.g video-name" className="form-control" id="video-name" required value={videoName} onChange={(event) => setVideoName(event.target.value)} />
                      </div>
                    </div>

                    <div className="col-lg-6">
                      <label htmlFor="category">Video Type</label>
                      <select className="form-control" required id="category" value={videoType} onChange={(event) => setVideoType(event.target.value)}>
                    ...
                    <div className="col-lg-6">
                      <div className="form-group">
                        ...
                        <input className="form-control" type="file" placeholder="Choose File Here..." id="thumbnail" required onChange={(event) => setVideoThumbnailFile(event.target.files[0])} />
                      </div>
                    </div>
                    ...
                    <div className="col-lg-6">
                      ...
                      <div className="custom-file">
                        <input type="file" className="custom-file-input" id="validatedCustomFile" required onChange={(event) => setVideoFile(event.target.files[0])} />
                    ...
                    <div className="col-lg-6">
                      ...
                      <div className="custom-file">
                        <input type="text" id="timeZone" placeholder="2024-03-12T13:59:51.183Z" className="form-control" value={timeZone} readOnly />
                      </div>
                    </div>
                  </div>
                </div>
